function [A,B,C,D,E,F] = ...
    calcTanhSegmentCoefficients(x0,x1,...
                                dydx0,dydx1,...
                                yNegInf,yInf, ...
                                xShift,xScale, ...
                                xAtIntYZero)
...
assert(isempty(yNegInf) || isempty(yInf), ...
    ['Error: this function has been formulated so that the function ',...
     ...
     'not both. Set the yNegInf or yInf that you do not care about',...
     ' to be empty []. ']);
...
if(isempty(yInf) == 0)
    ...
    %This means that yNegInf has a finite value, which means that dydx1=0
