...
%
% Plot COLORNAMES palettes in an RGB/DIN99/Lab/LCh/HSV/XYZ cube. Color names
...
if nargin<1
	...
	assert(isChRo(palette),...
        'SC:colornames_cube:palette:NotCharRowVector',...
...
if nargin<2
	...
	assert(isChRo(space),...
        'SC:colornames_cube:space:NotCharRowVector',...
        'The second input <space> must be a 1xN character vector')
